...
function Works() {
    ...
    return (
        ...
        >
                ...
                <div className="flex flex-col w-full sm:w-[930px]">
                    ...
                    <div className="flex flex-col sm:flex-row justify-start sm:justify-between items-start sm:items-center mt-4 sm:mt-6">
                        ...
                        <div className="flex gap-4 mt-4 sm:mt-0 flex-wrap justify-center sm:justify-start">
                            <button className="text-sm sm:text-base font-semibold text-off-white-dark-theme border border-off-white-dark-theme px-4 py-2 rounded-lg hover:bg-off-white-dark-theme hover:text-background-black transition">
                                DEVELOPMENT
                            </button>
                            <button className="text-sm sm:text-base font-semibold text-off-white-dark-theme border border-off-white-dark-theme px-4 py-2 rounded-lg hover:bg-off-white-dark-theme hover:text-background-black transition">
                                DESIGN
            ...
            {/* About Me Section */ }
            <div className="flex flex-col sm:flex-row justify-center items-center sm:items-start mt-16 sm:mt-24 px-4 sm:px-8 w-full sm:gap-8">
                {/* Left Column: Image */ }
                ...
                <div className="w-full sm:w-[50%] text-center sm:text-left">
                    <h3 className="text-off-white-dark-theme font-bold text-3xl sm:text-4xl md:text-5xl">
                        PRODUCT DESIGNER
                    </h3>
                    <p className="text-off-white-black text-base sm:text-xl md:text-xl lg:text-2xl mt-6 sm:mt-8 max-w-lg lg:max-w-md xl:max-w-[40ch] mx-auto sm:mx-0">
                    ...
                    <div className="mt-6 sm:mt-8 text-military-green font-bold text-xl sm:text-2xl md:text-3xl text-center sm:text-left">
                        (about me)
                    </div>
                    <p className="text-off-white-black text-base sm:text-lg md:text-base lg:text-lg mt-6 sm:mt-8 max-w-lg lg:max-w-md xl:max-w-[50ch] mx-auto sm:mx-0">
