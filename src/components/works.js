...
function Works() {
    ...
    return (
        ...
        >
            ...
            {/* Project Sections */ }
            { [ projectImage, projectImage2, projectImage3 ].map( ( image, index ) => (
                <div
                    key={ index }
            ...
            <div
                id="about"
                className="flex flex-col sm:flex-row justify-center pb-20 items-center sm:items-center mt-16 sm:mt-24 px-4 sm:px-8 w-full sm:gap-8 lg:gap-12"
                data-aos="zoom-in"
            >
                ...
                <div className="w-full sm:w-[50%] text-center sm:text-left flex flex-col items-center sm:items-start">
                    ...
                    <p className="text-off-white-black text-xl sm:text-xl md:text-3xl lg:text-4xl mt-6 sm:mt-8 max-w-lg lg:max-w-md xl:max-w-[45ch] mx-auto sm:mx-0">
                        I'm passionate about user experiences and the journey they take. I
                        specialize in designing and building minimal, user-centered, and
